...
<html lang="en">
        ...
        <div class="container">
            <div class="table-wrapper">
                ...
                <div class="clearfix">        
                        ...
                        <li class="page-item ${tag == o?"active":""}"><a href="manager?index=${o}" class="page-link">${o}</a></li>
                        </c:forEach>
                        <c:if test="${tag < endP}">
    ...
    <a href="home" style="margin-left: 270px"><button type="button" class="btn btn-primary">Back to home</button>
